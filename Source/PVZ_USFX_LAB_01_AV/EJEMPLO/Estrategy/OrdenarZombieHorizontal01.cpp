...
#include "OrdenarZombieHorizontal01.h"
...
// Sets default values
AOrdenarZombieHorizontal01::AOrdenarZombieHorizontal01()
{
...
void AOrdenarZombieHorizontal01::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AOrdenarZombieHorizontal01::Tick(float DeltaTime)
{
    ...
    if (ComenzarTick)
    {
        if (CantidadZombies == 5 && aux01) {
            ...
            MoverZombie01 = false;
            MoverZombie02 = true;
            GEngine->AddOnScreenDebugMessage(-1, 15.f, FColor::Yellow, FString::Printf(TEXT("contenedor_Nombres = 4h")));
        ...
        if (MoverZombie01)
        {
            if (CastReady)
            {
                ...
                GEngine->AddOnScreenDebugMessage(-1, 15.f, FColor::Yellow, FString::Printf(TEXT("Primer Zombie Horizontal")));
...
void AOrdenarZombieHorizontal01::Estrategias_Ataque(TMap<FString, AActor*> Actores)
{
    ...
    // Itera a través del TArray de nombres de actores
    for (const FString& ActorName : contenedor_Nombres)
    {
        ...
        if (FoundActor)
        {
            // Intenta realizar un cast al tipo de actor específico (AZombies)
...
AZombies* AOrdenarZombieHorizontal01::GetPrimerZombie()
{
	return nullptr;
}

AZombies* AOrdenarZombieHorizontal01::ZombieMover()
{
    class AZombies* ZombieWithMaxLife = nullptr;
...
void AOrdenarZombieHorizontal01::cambiarUbicacion(float _DeltaTime, int Ubi)
{
...
void AOrdenarZombieHorizontal01::CastPlanta(AActor* Planta, AActor* Torre)
{
